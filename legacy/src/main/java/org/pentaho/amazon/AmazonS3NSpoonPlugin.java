...
@LifecyclePlugin( id = "AmazonS3NSpoonPlugin", name = "Amazon S3N Spoon Plugin EE" )
public class AmazonS3NSpoonPlugin implements LifecycleListener, GUIOption<Object> {

  private final int s3Priority = 170;
